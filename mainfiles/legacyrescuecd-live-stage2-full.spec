...
livecd/fsscript: /worksrc/legacyrescuecd-src/mainfiles/fsscript-livecd.sh
livecd/splash_type:
livecd/splash_theme:
...
livecd/motd:
livecd/modblacklist:
livecd/root_overlay: /worksrc/legacyrescuecd-src/overlay-squashfs-x86 /worksrc/legacyrescuecd-bin/overlay-squashfs-x86
livecd/users:
livecd/volid: legacyrescuecd

boot/kernel: rescuecd

boot/kernel/rescuecd/sources: sys-kernel/std-sources
boot/kernel/rescuecd/config: /worksrc/legacyrescuecd-src/kernelcfg/config-fake-i686.cfg
boot/kernel/rescuecd/use: pcmcia usb -X png truetype 
boot/kernel/rescuecd/extraversion: i686
boot/kernel/rescuecd/packages:
	sys-apps/legacyrescuecd-scripts
